# DailyKit Product Brain v9.3

## Product Positioning

DailyKit is an offline-first Personal Life OS: a lightweight PWA for daily money, notes, habits, subscriptions, borrowed money, and shopping.
